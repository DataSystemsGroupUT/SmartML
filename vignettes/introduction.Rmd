...
result2 <- autoRLearn(2, system.file("extdata", "shuttle/train.arff", package = "SmartML"), system.file("extdata", "shuttle/test.arff", package = "SmartML")) # Option 2 runs for both classifier algorithm selection and parameter tuning for 2 minutes.
```
```{r, warning = FALSE}
