...
result2 <- autoRLearn(2, system.file("extdata", "/car/train.arff", package = "SmartML"), system.file("extdata", "/car/test.arff", package = "SmartML"), interp = TRUE) # Option 2 runs for both classifier algorithm selection and parameter tuning for 2 minutes.
```
```{r, warning = FALSE}
...
result3 <- autoRLearn(1, system.file("extdata", "/car/train.arff", package = "SmartML"), system.file("extdata", "/car/test.arff", package = "SmartML"), vRatio = 0.2, selectedFeats = c(1,2,5,6,7)) # Option 2 runs for both classifier algorithm selection and parameter tuning for 1 minute.
```
```{r, warning = FALSE}
