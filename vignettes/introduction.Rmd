...
result3 <- autoRLearn(3, system.file("extdata", "car/train.arff", package = "SmartML"), system.file("extdata", "car/test.arff", package = "SmartML"), vRatio = 0.2, selectedFeats = c(1,2,5,6,7)) # Option 2 runs for both classifier algorithm selection and parameter tuning for 3 minute.
```
```{r, warning = FALSE}
